...
ev(J.JS_EVENT_AXIS, 1, 0); ev(J.JS_EVENT_AXIS, 0, -32767); pad.poll(); check("왼스틱 왼쪽 끝 = 좌회전(+wz) 최대", J.command_from_gamepad(pad, *R), (0.0, 1.0, 0.0, False, False))
ev(J.JS_EVENT_AXIS, 0, 0); ev(J.JS_EVENT_AXIS, 3, -32767); pad.poll(); check("오른스틱 위 끝 = 높이 +1", J.command_from_gamepad(pad, *R), (0.0, 0.0, 1.0, False, False))
ev(J.JS_EVENT_AXIS, 3, 2000); pad.poll(); check("데드존 안 = 0", J.command_from_gamepad(pad, *R), (0.0, 0.0, 0.0, False, False))
